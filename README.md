...
An interactive tick-off checklist generated from the notes above — open
`companion.html` beside the sim.

```sh
node tools/build-companion.mjs
open companion.html
```
